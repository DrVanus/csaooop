...
struct HomeView: View {
    ...
    // Removed duplicate Fear & Greed view model and its models.
            ...
            NavigationView {
                ScrollView(.vertical, showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 16) {
                        ...
                        marketStatsSection
                        // Separated Market Sentiment section using the new modular view
                        MarketSentimentView()
                        aiAndInviteSection
                        trendingSection
                        topMoversSection
                    ...
                    .padding(.top)
                    .refreshable {
                        // Removed fearGreedVM.fetchIndex() call.
                        newsVM.fetchNews()
                    }
                }
